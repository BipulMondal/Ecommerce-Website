...
const BabyToys = () => {
    const { isLoading, babyToyProduct } = useProductContext();
    // console.log(babyToyProduct)
    if (isLoading) {
        return (
      ...
      return (
        <div>
      <div>
        <img className="w-full" src="images/babytoy.PNG" alt="logo" />
        <img className="w-full" src="images/babytoy2.PNG" alt="logo" />
      </div>
      <div>
        <div className='mx-24'>
          {babyToyProduct.map((curElem, index) => {
            return (
